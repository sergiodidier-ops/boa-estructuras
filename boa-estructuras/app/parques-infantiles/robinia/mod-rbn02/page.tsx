const fotos = [
  "/fotos/robinia/mod-rbn02/portada.png",
  "/fotos/robinia/mod-rbn02/mod-rbn02.png",
  "/fotos/robinia/mod-rbn02/mod-rbn02-aerea.png",
];

export default function ModRbn02Page() {
  return (
    <main className="min-h-screen bg-[#f3f0e7] px-6 py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 flex justify-center">
          <a
            href="/fotos/robinia/mod-rbn02/ficha-tecnica.pdf"
            target="_blank"
