export default function ModHoursePage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#fff7e8] via-[#f8fbff] to-white px-6 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          <img
            src="/fotos/independiente/muelles/mod-hourse/portada.png"
            alt="MOD-HOURSE"
        ...
        <div className="mt-12 text-center">
          <a
            href="/fotos/independiente/muelles/mod-hourse/ficha-tecnica.pdf"
            target="_blank"
