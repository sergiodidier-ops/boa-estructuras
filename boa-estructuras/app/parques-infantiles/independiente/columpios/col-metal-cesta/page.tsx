export default function ColMetalCestaPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-blue-50 px-6 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-10">
          <img
            src="/fotos/independiente/columpios/col-metal-cesta/portada.png"
            alt="COL-METAL-CESTA"
        ...
        <div className="text-center">
          <a
            href="/fotos/independiente/columpios/col-metal-cesta/ficha-tecnica.pdf"
            target="_blank"
